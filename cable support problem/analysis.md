...
| **Steiner Tree mehlhorn approximation** |  Runs the mehlhorn steiner tree approximation algorithm, with sources/dest as terminals, then runs dijkstra to find shortest paths.   | 156.37 | 317.58 | 473.95 |  <img src="animation_gifs\Sample Project with Steiner Tree mehlhorn approximation.gif" style="width:600px" align="left"/>|
